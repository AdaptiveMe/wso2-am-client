...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8243";
    ...
    public ApiClient() {
        ...
        authentications.put("userKeySecret", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8243
